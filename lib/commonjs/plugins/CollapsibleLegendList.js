...
exports.default = CollapsibleLegendList;
...
var _reanimated = require("@legendapp/list/reanimated");
...
function CollapsibleLegendList(_ref) {
  let {
  ...
  const internalProgressViewOffset = (0, _reactNativeReanimated.useSharedValue)(0);
  (0, _react.useEffect)(() => {
    return () => {
  ...
  }, /*#__PURE__*/_react.default.createElement(_reanimated.AnimatedLegendList, _extends({
    ref: scrollViewRef,
